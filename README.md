...
Adding a translation is easy. All you have to do is go to https://github.com/szTheory/exifcleaner/blob/master/.resources/strings.json and click on "Edit this file" and add an entry for the new language underneath the other ones. So for example if you wanted to add a Spanish translation, where it says:
